...
def PS_BLR(params, map_A, map_B, err_data, f,Mc,muBLR=1.):
	...
	#    print lc_BLR 
        ...
        lc_A = Mc * ml_A * lc_c + Mc * fBLR * muBLR * lc_BLR
        lc_B = Mc * ml_B * lc_c + Mc * fBLR * muBLR * lc_BLR
        lc_reverberation = -2.5 * np.log10(lc_A/lc_B)
        #lc_reverberation -= lc_reverberation[0]
...
parser.add_argument('tBLR', metavar='tBLR', type=int,help='Time lag of the reverberation')
parser.add_argument('sigma', metavar='sigma', type=int,help='Sigma of the DRW')
